...
variable "proximity_placement_group_id" {
  description = "https://learn.microsoft.com/en-us/azure/aks/reduce-latency-ppg (Optional) The ID of the Proximity Placement Group where the Virtual Machine Scale Set that powers this Node Pool will be placed. Changing this forces a new resource to be created."
  type        = string
  default     = null
}
